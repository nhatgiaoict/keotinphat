var productController = function () {
    ...
    function registerEvents() {
        ...
        $("#fileInputImage").on('change', function () {
            ...
            $.ajax({
                ...
                success: function (path) {
                    $('#txtImage').val(path);
                    lg.notify('Upload image succesful!', 'success');

                },
                error: function () {
                    lg.notify('There was error uploading files!', 'error');
                }
            });
        });
        ...
        $('#btn-export').on('click', function () {
            $.ajax({
                ...
                error: function () {
                    lg.notify('Has an error in progress', 'error');
                    lg.stopLoading();
                }
            });
        });
    ...
    function saveProduct(e) {
        if ($('#frmMaintainance').valid()) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    lg.notify('Update product successful', 'success');
                ...
                error: function () {
                    lg.notify('Has an error in save product progress', 'error');
                    lg.stopLoading();
                }
            });
            return false;
    ...
    function loadCategories() {
        $.ajax({
            ...
            error: function (status) {
                console.log(status);
                lg.notify('Cannot loading product category data', 'error');
            }
        });
    }
            ...
            success: function (response) {
                ...
                $.each(response.Results, function (i, item) {
                    render += Mustache.render(template, {
                        ...
                        Price: lg.formatNumber(item.Price, 0),
